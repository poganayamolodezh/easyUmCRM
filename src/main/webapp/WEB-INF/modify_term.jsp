...
<h2>Для модификации "${term.term}"семестра отредактируйте данные и нажмите кнопку «Применить»</h2>
...
<div class = "table23">
    <form action="/term-modify" method="post">
        ...
        <div class="b2 mt30 textdis">
            <select name="selectTerm" class="select-term"  multiple required >
        ...
        <%--      24--%>
        <%--    </a>--%>
        <input type="number" class = "btn" placeholder="${term.duration}" name="duration">
        ...
        <div class="b2 mt30 textdis">
            <select name="selectDisciplines" class="select-discipline"  multiple required >
                <c:forEach items="${disciplineList}" var = "d">
...
<div class = "table235">
    ...
    <input type="submit" name="" value="Применить" class="btn2">
